...
private:
    ...
    // helpers
    bool get_pose_in_frame(const std::string & target_frame, const std::string & source_frame, const rclcpp::Time & stamp, geometry_msgs::msg::PoseStamped & out_pose);
    bool poses_changed( const find_cubes::msg::CubesPoses & prev, const find_cubes::msg::CubesPoses & now_msg) const;
    ...
    // Previous poses
    find_cubes::msg::CubesPoses previous_;
